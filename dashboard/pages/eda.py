...
def show():
    ...
    resultados = {
        "XGBoost": {
            ...
            "Classification Report": {
                "0": {
                    "precision": 0.9755051606338131,
                    "recall": 0.9814259597806215,
                    "f1-score": 0.9784566033609157,
                    "support": 13675.0,
                },
                "1": {
                    "precision": 0.7462537462537463,
                ...
                "macro avg": {
                    "precision": 0.8608794534437797,
                    "recall": 0.8352701754622665,
                    "f1-score": 0.8475016829754218,
                    "support": 14759.0,
                },
                "weighted avg": {
                    "precision": 0.9586673983743109,
        ...
        "RandomForest": {
            ...
            "Classification Report": {
                "0": {
                    "precision": 0.9807649789962415,
                    "recall": 0.973162705667276,
                    "f1-score": 0.976949053002496,
                    "support": 13675.0,
                },
                "1": {
                    "precision": 0.6915966386554622,
                ...
                "macro avg": {
                    "precision": 0.8361808088258518,
                    "recall": 0.8661938989590993,
                    "f1-score": 0.8503918527985215,
                    "support": 14759.0,
                },
                "weighted avg": {
                    "precision": 0.9595265156227472,
        ...
        "LogisticRegression": {
            ...
            "Classification Report": {
                "0": {
                    "precision": 0.9775204359673024,
                    "recall": 0.8394881170018281,
                    "f1-score": 0.9032613399425626,
                    "support": 13675.0,
                },
                "1": {
                    "precision": 0.27197346600331673,
                ...
                "macro avg": {
                    "precision": 0.6247469509853096,
                    "recall": 0.797972840788737,
                    "f1-score": 0.6516794623596687,
                    "support": 14759.0,
                },
                "weighted avg": {
                    "precision": 0.9257003319330888,
        ...
        "LightGBM": {
            ...
            "Classification Report": {
                ...
                "macro avg": {
                    "precision": 0.8606535520545606,
                    "recall": 0.8325757739295858,
                    "f1-score": 0.845923122636973,
                    "support": 14759.0,
                },
                "weighted avg": {
                    "precision": 0.9582745268885305,
    ...
    dados_plot = pd.DataFrame({"Classe": [], "Métrica": [], "Valor": []})
    ...
    fig_conf_plotly.update_layout(title_text="<b>Matriz de Confusão</b>", title_x=0.5)
    ...
    if dados_holdout:
        ...
        col3.metric(
            "F1-Score (Classe 1)", f"{dados_holdout['F1-Score (Classe 1)']:.4f}"
        )
        ...
        valores = [
            dados_holdout["Precisão (Classe 1)"],
